...
import com.sd.laborator.services.RegenerateAService
...
class StackAppComponent {
    ...
    @Autowired
    private lateinit var firstService: RegenerateAService
    ...
    fun recieveMessage(msg: String) {
        ...
        var result: String? = firstService.execute(A,B,processed_msg)
        println("result: ")
        println(result)
