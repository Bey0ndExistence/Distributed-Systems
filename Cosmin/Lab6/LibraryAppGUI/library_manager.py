    ...
    def search(self):
        ...
        if search_string:
            if self.author_rb.isChecked():
                url = '/find-and-print?author={}'.format(search_string.replace(' ', '%20'))
            elif self.title_rb.isChecked():
                url = '/find-and-print?title={}'.format(search_string.replace(' ', '%20'))
            else:
                url = '/find-and-print?publisher={}'.format(search_string.replace(' ', '%20'))
